...
const SCANNER_ELEMENT_ID = 'crossword-qr-scanner-region';
...
export default function CrosswordJoinScan() {
    ...
    try {
      ...
      await scanner.start(
        ...
        async (decodedText: string) => {
          ...
          setScanning(false);
          navigate(`/crossword/join/${code.toUpperCase()}`);
        },
        () => {
  ...
  function handleManualSubmit(e: React.FormEvent) {
    ...
    if (code) navigate(`/crossword/join/${code}`);
  }

  return (
    <div className="screen screen-center">
      <h1 className="screen-title">Unirse a un crucigrama</h1>
